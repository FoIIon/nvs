				...
				?>
					...
					<div class="row g-2 g-lg-5" >
						<div class="col-lg-4 mx-auto">
								...
								<div class="row align-items-center">
									<div class="col-2">
										<div class="d-flex align-items-center">
											<p class="fw-bold m-0">PV</p>
										</div>
									</div>
									<div class="col">
										<div class="progress position-relative">
											<div class="progress-bar bg-<?php echo ''.get_progress_bar_color($pv_perso,$pvMax_perso); ?>" style="width:<?php $pourc = $pv_perso*100/$pvMax_perso; echo ''.round($pourc)?>%" role="progressbar" aria-valuenow="<?php $pourc = $pv_perso*100/$pvMax_perso; echo "".round($pourc)?>" aria-valuemin="0"
												aria-valuemax="100">
											</div>
											<small class="justify-content-center d-flex position-absolute w-100">
												<?php $pourc = $pv_perso*100/$pvMax_perso; echo "".round($pourc)."% ou ".$pv_perso."/".$pvMax_perso ?>
											</small>
										</div>
									</div>
								</div>
							...
							<!-- Fin barre PV  -->
							 <!--tableau carac perso  style="background: red;"-->
							<div class="mb-3">
								<?php require_once("page_jeu/tableau_carac_perso.php" ); ?>
							</div>
							<!-- Fin tableau carac perso -->
							<!--tableau carac combat "-->
							<div class="mb-3">
								<?php require_once("page_jeu/tableau_carac_combat.php" ); ?>
							</div>
							<!-- Fin tableau carac combat -->
